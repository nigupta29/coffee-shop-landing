...
export default function Hero() {
  ...
  return (
    <section className='bg-orange-100/70'>
      <Container>
        <article className='mx-auto flex flex-col items-center justify-between gap-8  md:flex-row'>
          <div className='flex flex-col space-y-10'>
            ...
            <div className='flex w-full justify-between md:justify-start md:gap-5'>
          ...
          <div className='md:w-1/2 lg:w-auto'>
            <img
              src={imgURL}
              alt='Coffee hero'
              className='ml-auto h-80 w-80 rounded-full object-cover drop-shadow-2xl lg:h-96 lg:w-96'
              loading='lazy'
            />
          </div>
        </article>
